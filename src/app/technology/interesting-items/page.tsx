          ...
          {interestingItems.map((item) => (
            <li key={item.idx}>
              <Link
                ...
                className="group block overflow-hidden border border-neutral-200 bg-white transition-shadow hover:shadow-lg"
              >
                ...
                <div className="p-4">
                  <span className="inline-block bg-neutral-800 px-2 py-0.5 text-[11px] font-semibold text-white">
                    {item.category}
                  </span>
